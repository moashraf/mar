	        		...
	        		<div class="header-mobile-menu">
	          		...
	          		<div class="mCustomScrollbar light" data-mcs-theme="minimal-dark">
						...
						<ul class="navi-level-1 hover-style-2 main-navi">
	                        ...
	                        <li class="has-sub"><a  title="{{ trans('langsite.Home')}}"  href="{{ URL::to('/').'/'.App::getLocale().'/all_news/'}}"><span>{{ trans('langsite.services')}}</span></a>
	                        </li>
...
<ul class="navi-level-1 hover-style-2 main-navi nav-r">
	...
	<li class="has-sub"><a  title="{!! site_settings('Web_site_name')  !!} "  href="{{ URL::to('/').'/'.App::getLocale().'/all_news/'}}"><span><i class="fas fa fa-check"></i> {{ trans('langsite.services')}}</span></a>
	</li>
...
<i class="fas fa fa-file"></i> {{ trans('langsite.News')}}</span></a></li>
					...
					<nav class="nav-r">
						<ul>
						   <li class="has-sub"><a   title="{!! site_settings('Web_site_name')  !!} " href="{{ URL::to('/').'/'.App::getLocale() }}"><span>{{ trans('langsite.Home')}}</span></a>
	                        ...
	                        <li class="has-sub"><a  title="{!! site_settings('Web_site_name')  !!} "  href="{{ URL::to('/').'/'.App::getLocale().'/all_news/'}}"><span>{{ trans('langsite.services')}}</span></a>
	                        </li>
 `							<li class="has-sub"><a   title="{!! site_settings('Web_site_name')  !!} " href="{{ URL::to('/').'/'.App::getLocale().'/all_news/'}}"><span>{{ trans('langsite.Projects')}}</span></a></li>
<li class="has-sub"><a href="{{ URL::to('/').'/'.App::getLocale().'/all_news/'}}"><span>{{ trans('langsite.News')}}</span></a>
	                        </li>
